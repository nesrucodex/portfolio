        ...
        >
          ...
          >
            <div className="aspect-square relative rounded-2xl overflow-hidden border shadow-lg">
              <Image src="/placeholder.svg?height=600&width=600" alt="Nesru Codex" fill className="object-cover" />
            </div>
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                ...
                user-friendly web applications. With years of experience in both frontend and backend development, I
                bring ideas to life through clean code and thoughtful architecture.
              </p>
              <p>
                My journey in software development began with a curiosity about how things work on the web, which
                evolved into a career building solutions that solve real-world problems. I'm constantly learning and
