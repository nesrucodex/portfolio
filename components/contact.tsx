              ...
              <CardContent className="flex-grow">
                <div className="space-y-6">
                  <p className="text-muted-foreground">
                    Whether you have a question about a project, job opportunity, or just want to say hello, I'm always
                    open to connecting with fellow developers and potential clients.
                  </p>
                  ...
                  <div className="pt-4">
                    <p className="text-sm text-muted-foreground">
                      Based in: <span className="font-medium text-foreground">San Francisco, CA</span>
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Available for:{" "}
                      <span className="font-medium text-foreground">Freelance, Full-time opportunities</span>
                    </p>
                  </div>
                </div>
              </CardContent>
